...
import com.arsene.repository.ProductRepository;
import com.arsene.service.ProductService;
...
public class ProductResourceIntTest {
    ...
    private static final String DEFAULT_DISCOUNTED_PRICE = "AAAAAAAAAA";
    private static final String UPDATED_DISCOUNTED_PRICE = "BBBBBBBBBB";
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getImage2()).isEqualTo(DEFAULT_IMAGE_2);
        assertThat(testProduct.getThumbnail()).isEqualTo(DEFAULT_THUMBNAIL);
        assertThat(testProduct.getDisplay()).isEqualTo(DEFAULT_DISPLAY);
    }
    ...
    @Test
    @Transactional
    public void checkDiscountedPriceIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].discountedPrice").value(hasItem(DEFAULT_DISCOUNTED_PRICE.toString())))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.discountedPrice").value(DEFAULT_DISCOUNTED_PRICE.toString()))
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getImage2()).isEqualTo(UPDATED_IMAGE_2);
        assertThat(testProduct.getThumbnail()).isEqualTo(UPDATED_THUMBNAIL);
        assertThat(testProduct.getDisplay()).isEqualTo(UPDATED_DISPLAY);
    }
