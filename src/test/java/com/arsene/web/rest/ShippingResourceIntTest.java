...
public class ShippingResourceIntTest {
    ...
    private static final Double DEFAULT_SHIPPING_COST = 1D;
    private static final Double UPDATED_SHIPPING_COST = 2D;
    ...
    public void createShipping() throws Exception {
        ...
        assertThat(testShipping.getShippingCost()).isEqualTo(DEFAULT_SHIPPING_COST);
    }
    ...
    public void getAllShippings() throws Exception {
        ...
        restShippingMockMvc.perform(get("/api/shippings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].shippingType").value(hasItem(DEFAULT_SHIPPING_TYPE.toString())))
    ...
    public void getShipping() throws Exception {
        ...
        restShippingMockMvc.perform(get("/api/shippings/{id}", shipping.getId()))
            ...
            .andExpect(jsonPath("$.shippingType").value(DEFAULT_SHIPPING_TYPE.toString()))
    ...
    public void updateShipping() throws Exception {
        ...
        assertThat(testShipping.getShippingCost()).isEqualTo(UPDATED_SHIPPING_COST);
    }
