...
public class OrderItemsResourceIntTest {
    ...
    private static final Double DEFAULT_UNITY_COST = 1D;
    private static final Double UPDATED_UNITY_COST = 2D;
    ...
    public void createOrderItems() throws Exception {
        ...
        assertThat(testOrderItems.getAttributes()).isEqualTo(DEFAULT_ATTRIBUTES);
        assertThat(testOrderItems.getProductName()).isEqualTo(DEFAULT_PRODUCT_NAME);
        assertThat(testOrderItems.getQuantity()).isEqualTo(DEFAULT_QUANTITY);
        assertThat(testOrderItems.getUnityCost()).isEqualTo(DEFAULT_UNITY_COST);
    }
    ...
    public void getAllOrderItems() throws Exception {
        ...
        restOrderItemsMockMvc.perform(get("/api/order-items?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].unityCost").value(hasItem(DEFAULT_UNITY_COST.doubleValue())));
    }
    ...
    public void getOrderItems() throws Exception {
        ...
        restOrderItemsMockMvc.perform(get("/api/order-items/{id}", orderItems.getId()))
            ...
            .andExpect(jsonPath("$.unityCost").value(DEFAULT_UNITY_COST.doubleValue()));
    }
    ...
    public void updateOrderItems() throws Exception {
        ...
        OrderItems testOrderItems = orderItemsList.get(orderItemsList.size() - 1);
        assertThat(testOrderItems.getAttributes()).isEqualTo(UPDATED_ATTRIBUTES);
        assertThat(testOrderItems.getProductName()).isEqualTo(UPDATED_PRODUCT_NAME);
        assertThat(testOrderItems.getQuantity()).isEqualTo(UPDATED_QUANTITY);
        assertThat(testOrderItems.getUnityCost()).isEqualTo(UPDATED_UNITY_COST);
    }
